...
from core.wrappers.mrc import Card
...
TASKS_KIDS = {
    ...
    (12, 4): Task('Испеки имбирное печенье по рецепту', text_yesterday='Завтра будет что-то вкусненькое.'),
    (12, 5): Task('Напиши письмо Деду Морозу, и положи его в холодильник, так он точно его получит.',
                  text_yesterday='Для завтрашнего задания понадобится литочек и ручка.'),
    ...
    (12, 9): Task('Сделай из бумаги гирлянду.', text_yesterday='Завтра займёмся творчеством'), # https://www.youtube.com/watch?v=8DqzwKrcA-w
    (12, 10): Task('Выучи любой новогодний стих.', text_yesterday='Завтра потренеруем память.'),
    ...
    (12, 15): Task('Вырежи снежинки из бумаги и укрась окна в доме.', text_yesterday='Завтра понадобится бумага «А4», точнее, много бумаги.'),
    (12, 16): Task('Сделай домашнее мороженое по этому рецепту', text_yesterday='Завтра будет что-то вкусненькое.'), # https://www.youtube.com/watch?v=aWX1YYz8Uaw
    ...
    (12, 21): Task('Собери большой пазл с новогодней картиной. А Если такого нет, то попроси у друзей или родителей.', 
                   text_yesterday='Если вы любите собирать паззлы, то завтрашнее задание вам понравится'),
    ...
    (12, 25): Task('Свари детский глинтвейн', text_yesterday='Завтра пригодятся навыки повара или помощь родителей.'),  # https://www.youtube.com/watch?v=FcWGjhMp6fI
    (12, 26): Task('Слепи новогоднюю поделку из солёного теста.', text_yesterday='Завтра что-то слепим.'),  # https://www.youtube.com/watch?v=5qRQDruyFSc
    (12, 27): Task('Сделай горячий шоколад.', text_yesterday='Что-то же такое горячее ждёт нас завтра?'),  # https://www.youtube.com/watch?v=-oSrOxMQzTM
    (12, 28): Task('Пускай мыльные пузыри на морозе. Будет интересно! Обещаю',
                   text_yesterday='Завтра ждём морозную погоду, она нам понадобится'), # https://www.youtube.com/watch?v=VgtR5XEWJZA
