...
TASKS_KIDS = {
    ...
    (12, 5): Task('Собери большой пазл с новогодней картиной. А Если такого нет, то попроси у друзей или родителей.',
    ...
    (12, 8): Task('Послушай новогоднюю музыку. Когда захотите - просто попросите меня: «Маруся, включи новогоднюю музыку»',
    ...
    (12, 12): Task('Сделай какао с маршмеллоу. Самостоятельно или с родителями.',
    ...
    (12, 13): Task('Посмотри со всей семьёй ваши старые фотографии или фотографии уходящего года.',
    ...
    (12, 15): Task('Вырежи снежинки из бумаги и укрась окна в доме.',
                   ...
                   card=CardLink(url='https://www.youtube.com/watch?v=4emIrvAKvjw',
                                 ...
                                 image_id=IMAGE_ID)),
    (12, 16): Task('Сделай домашнее мороженое по этому рецепту. Самостоятельно или с родителями.',
                   text_yesterday='Завтра будет что-то вкусненькое.',
    ...
    (12, 17): Task('Поиграй с семьей или друзьями в настольную игру. '
    ...
    (12, 21): Task('Напиши письмо Деду Морозу, и положи его в холодильник, так он точно его получит.',
...
NOT_TOMORROW_PHRASES = [
    ...
    'Хорошо. До завтра',
    'Поняла. До завтра',
    'Возвращайтесь за заднием завтра.',
]