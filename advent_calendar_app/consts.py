...
TASKS_KIDS = {
    ...
    (12, 10): Task('Выучите любой новогодний стих, который тебе понравится.', text_yesterday='Завтра потренеруем память.'),
...
TASKS_OLDS = {
    ...
    (12, 10): Task('Вспомните события, которые Вас сильно порадовали в этом году {}. Порадуйтесь ещё раз.'.format(EMOJI.elka),
                  text_yesterday='Завтра будет много радостных событий.'),
    (12, 11): Task('Сходите в гости к родственникам или друзьям.', text_yesterday='Завтра пойдём в гости.'),
