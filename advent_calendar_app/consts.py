...
# От 14 до 20
TASKS_OLDS = {
    (12, 1): Task('Делай зимние фото и видеозаписи каждый день, чтобы к Новому году получился мини-фильм. '
                  'Будет круто, если на фотографии попадёт выполнение заданий из календаря. '
                  'Приятного выполнения заданий!'),
    (12, 2): Task('Собери ненужные вещи, продай или отдай их тем, кому они нужнее.'),
    (12, 3): Task('Составьте список подарков для родных и близких. Ведь нужно ещё время, чтобы купить эти подарки.'),
    (12, 4): Task('Сделай кормушку для птичек, или просто возьми еды и накорми их. '
    ...
    (12, 7): Task('Послушай новогоднюю музыку. Когда захотите - просто попросите меня: «Маруся, включи новогоднюю музыку»',
                  text_yesterday='Завтра гарантировано поднимем новогоднее настроение.'),
    ...
    (12, 10): Task('Вспомните события, которые Вас сильно порадовали в этом году. Порадуйтесь ещё раз.',
                  text_yesterday='Завтра будет много радостных событий.'),
    (12, 11): Task('Сходи в гости к родственникам или друзьям.', text_yesterday='Завтра пойдём в гости.'),
    (12, 12): Task('Посмотри новогодний фильм, например, «Один дома» или «Полярный экспресс» или '
                   '«Гринч - похититель рождества». '
                   'Выберите свой любимый или который никогда не видели.',
                   text_yesterday='Для завтрашнего задания нам понадобится свободный вечер.'),
    (12, 13): Task('Поиграй с семьей или друзьями в настольную игру. '
                   'А ещё, у меня тоже есть интересные игры. '
                   'Когда будете готовы поиграть - просто скажите: «Маруся, давай поиграем»',
                   text_yesterday='Завтра будем играть.'),
    (12, 14): Task('Сделай домашнее мороженое по этому рецепту. Самостоятельно или с родителями.',
                   text_yesterday='Завтра будет что-то вкусненькое.',
                   card=CardLink(url='https://www.youtube.com/watch?v=aWX1YYz8Uaw',
                                 title='Мороженое своими руками',
                                 text='Сделайте вкусное и полезное мороженое своими руками',
    ...
    (12, 15): Task('Укрась квартиру или дом к Новому году.',
                   text_yesterday='Завтра Вас ждёт приятное семейное задание'),
    ...
    (12, 24): Task('Заварите и выпейте фруктовый чай'),
    (12, 25): Task('Покатайтесь на горке, на санках или на плюшке. Удачной прогулки.'),
    ...
    (12, 29): Task('Научитесь чему-то новому. Посмотрите обучающие ролики на youtube. '
                   'На празднике сможете похвастаться своими новыми умениями.'),
