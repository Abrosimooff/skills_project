...
TASKS_KIDS = {
    ...
    (12, 2): Task(
        text='Напишите себе письмо в будущее, на следующий Новый год, '
             'положите его в укромном месте и открой его через год.',
    ...
    (12, 4): Task(text='Сегодня нужно научиться рисовать Деда Мороза.',
    ...
    (12, 5): Task('Соберите большой пазл с новогодней картиной. А Если такого нет, то попросите у друзей или родителей.',
                  text_yesterday='Если вы любите собирать пазлы, то завтрашнее задание вам понравится'),

    (12, 6): Task('Сделайте новогоднюю ёлку из ниток по инструкции.',
    ...
    (12, 7): Task('Посмотрите новогодний мультфильм «Зима в Простоквашино». '
                  'Разрешается не останавливаться на одном мультфильме.',
    ...
    (12, 8): Task('Послушайте новогоднюю музыку. '
                  'Когда захотите - просто попросите меня: «Маруся, включи новогоднюю музыку»',
                  text_yesterday='Завтра гарантировано поднимем новогоднее настроение.'),
    (12, 9): Task('Сделайте из бумаги гирлянду.', text_yesterday='Завтра займёмся творчеством',
    ...
    (12, 11): Task('Украсьте квартиру или дом к Новому году.',
                   text_yesterday='Завтра Вас ждёт приятное семейное задание'),
    (12, 12): Task('Сделайте какао с маршмеллоу. Самостоятельно или с родителями.',
    ...
    (12, 14): Task('Посмотрите новогодний фильм, например, «Один дома» или «Полярный экспресс» '
                   'или «Гринч - похититель рождества»',
                   text_yesterday='Для завтрашнего задания нам понадобится свободный вечер.'),
    (12, 15): Task('Вырежте снежинки из бумаги и укрась окна в доме.',
                   ...
                   card=CardLink(url='https://www.youtube.com/watch?v=4emIrvAKvjw',
                                 ...
                                 image_id=IMAGE_ID)),
    (12, 16): Task('Сделайте домашнее мороженое по этому рецепту. Самостоятельно или с родителями.',
                   text_yesterday='Завтра будет что-то вкусненькое.',
    ...
    (12, 17): Task('Поиграйте с семьей или друзьями в настольную игру. '
                   ...
                   'Когда будете готовы поиграть - просто скажите: «Маруся, давай поиграем»',
    ...
    (12, 19): Task('Соберите всю свою семью и вместе нарядите ёлку, если она ещё не наряжена.',
    ...
    (12, 22): Task('Сделайте семейную фотографию возле ёлки.', text_yesterday='Завтра соберёмся возле ёлочки.'),
    (12, 23): Task('Поиграй в «12 записок». '
                   ...
                   text_yesterday='Завтра будет интересная игра',
    ...
    (12, 26): Task('Слепи новогоднюю поделку из солёного теста.',
                   text_yesterday='Завтра из чего-то вкусненького сделаем что-то красивенькое.',
    ...
    (12, 27): Task('Сделай горячий шоколад. Самостоятельно или с родителями.',
...
TASKS_OLDS = {
    (12, 1): Task('Делайте зимние фото и видеозаписи каждый день, чтобы к Новому году получился мини-фильм. '
                  'Будет круто, если на фотографии попадёт выполнение заданий из календаря. '),
    (12, 2): Task('Соберите ненужные вещи, продай или отдай их тем, кому они нужнее. '
                  'Это можно сделать, например, на Юле или Авито.', text_yesterday='А у вас тоже много ненужных вещей? Что-то нужно с этим делать.'),
    ...
    (12, 4): Task('Сделайте кормушку для птичек, или просто возьми еды и накорми их. '
                  'Можно совместить с прогулкой по парку.',
                  text_yesterday='Завтра сделаем одно хорошее дело, а может быть и не одно'),
    (12, 5): Task('Сделайте дело, которое вы долго откладывали. Пришло время закончить такие дела.', 
                  text_yesterday='Только вам известно, что будет завтра.'),
    (12, 6): Task('Поиграйте в «Тайный Санта». Договоритесь с друзьями о цене подарка и проведите жеребъёвку.', 
                  text_yesterday='Завтра начнём игру.'),
    (12, 7): Task('Послушайте новогоднюю музыку. Когда захотите - просто попросите меня: «Маруся, включи новогоднюю музыку»',
                  text_yesterday='Завтра гарантировано поднимем новогоднее настроение.'),
    (12, 8): Task('Посмотрите ваши старые фотографии или фотографии уходящего года. Устройте вечер воспоминаний.',
                   text_yesterday='Завтра вас ждёт ещё одно приятное семейное задание'),
    (12, 9): Task('Сделайте какао с маршмеллоу. Будет вкусно, я уже завидую.',
                   text_yesterday='Завтра будет что-то вкусненькое.',
                   card=CardLink(url='https://www.youtube.com/watch?v=9fACTxDAaKY',
                                 title='Мятное какао с маршмеллоу',
                                 text='Выберите для себя подходящий рецепт какао.',
    ...
    (12, 10): Task('Вспомните события, которые Вас сильно порадовали в этом году. Порадуйтесь ещё раз.',
                  text_yesterday='Завтра будет много радостных событий.'),
    ...
    (12, 12): Task('Посмотрите новогодний фильм, например, «Один дома» или «Полярный экспресс» или '
                   ...
                   'Выберите свой любимый или который никогда не видели.',
                   text_yesterday='Для завтрашнего задания нам понадобится свободный вечер.'),
    (12, 13): Task('Поиграйте с семьей или друзьями в настольную игру. '
                   'А ещё, у меня тоже есть интересные игры. '
                   'Когда будете готовы поиграть - просто скажите: «Маруся, давай поиграем»',
                   text_yesterday='Завтра будем играть.'),
    (12, 14): Task('Сделайте домашнее мороженое по этому рецепту. Самостоятельно или с родителями.',
                   text_yesterday='Завтра будет что-то вкусненькое.',
                   card=CardLink(url='https://www.youtube.com/watch?v=aWX1YYz8Uaw',
                                 title='Мороженое своими руками',
                                 text='Сделайте вкусное и полезное мороженое своими руками',
    ...
    (12, 15): Task('Украсьте квартиру или дом к Новому году.',
                   text_yesterday='Завтра Вас ждёт приятное семейное задание'),
    ...
    (12, 18): Task(text='Испеките имбирные пряники по рецепту',
                  text_yesterday='Завтра будет что-то вкусненькое.',
    ...
    (12, 20): Task('Сходите на каток. Если вы никогда не стояли на коньках - это отличное время, чтобы начать!', 
                   text_yesterday='Завтра покатаемся.'),
    (12, 21): Task('Прогуляйтесь по зимненму лесу или вечернему городу, согреваясь стаканчиком тёплого чая или кофе.', 
                   text_yesterday='Надеюсь, погода завтра не подведёт.'),
    (12, 22): Task('Сегодня нужно выбрать лучшее фото уходящего года, распечатать его и поставить в рамочку.', 
                   text_yesterday='Завтра найдём иголку в стоге сена.'),
    (12, 23): Task('Смените телефонный звонок на новогодний.',
                   text_yesterday='Завтра поменяем кое-что в телефоне'),
    (12, 24): Task('Заварите и выпейте фруктовый чай', text_yesterday='Завтра попьём вкусного чаю'),
    (12, 25): Task('Покатайтесь на горке, на санках или на плюшке. Удачной прогулки.', text_yesterday='Завтра покатаемся'),
    (12, 26): Task('Приготовьте салат, который вы ещё никогда не делали. '
                   'Это будет маленькая тренеровка перед новым годом и, возможно, ваш новый коронный рецепт.',
                   text_yesterday='Завтра будет что-то вкусненькое'),
    (12, 27): Task('Нужно сделать уборку в доме. Праздник приближается, нужно быть к нему готовым.',
    ...
    (12, 30): Task('Сегодня давайте просто отдохнём. Надеюсь это задание у вас получится выполнить.',
    ...
    (12, 31): Task('Поздравляю вас! Уже сегодня пробьют куранты и начнётся Новый год! '
                   ...
                   'Можете сделать фильм и поделиться им с близкими. Хороших выходных!',
                   text_yesterday='Завтра будем отмечать долгожданный Новый год.'),
}
